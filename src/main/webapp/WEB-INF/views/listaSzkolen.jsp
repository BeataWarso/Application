...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top"
		id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="#page-top">Panel
				Użytkownika</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="<c:url value="/userPanel/listaSzkolen" /> ">Aktualna
							oferta szkoleń</a></li>

					<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="<c:url value="/userPanel/historia" /> ">Historia moich
							szkoleń</a></li>


					<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="<c:url value="/userPanel/usun" /> ">Usuń konto</a></li>
			...
			<div class="row">
				<div class="col-lg-10 mx-auto">
					<h1 class="text-uppercase">
						<strong>Przeglądaj listę szkoleń</strong>
					</h1>
					<hr>
				</div>
				<div class="col-lg-8 mx-auto">
					<p class="text-faded mb-5">zapisz się na szkolenie</p>
			...
			<table class="table table-striped table-hover table-bordered">
				...
				<c:forEach items="${trainings}" var="training">
					<tr>
						...
						<td><a
							href="<c:url value="/userPanel/detaleSzkolenia/${training.id }"/>">
