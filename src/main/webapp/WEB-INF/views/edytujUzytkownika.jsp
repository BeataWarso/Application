...
<section id="services">
	<div class="container">
		<div class="col-lg-8 col-lg-offset-2 text-center">
			<h1 class="section-heading">Edytuj użytkownika</h1>
		...
		<fieldset class="border p-2">
			...
			<form:form method="post" modelAttribute="user">
				...
				<div class="form-group">
					...
					<form:input placeholder="np: OWU - praktyczne aspekty"
						path="username" id="username" cssClass="form-control" />
				</div>
				...
				<div class="form-group">
					...
					<form:input placeholder="np: OWU - praktyczne aspekty"
						path="password" id="password" cssClass="form-control" />
				</div>

				<div class="form-group">
					<label for="email">E-mail</label>
					<form:errors path="email" cssStyle="color: red;" />
					<form:input placeholder="np: OWU - praktyczne aspekty" path="email"
