...
<body id="page-top">
	...
	<section id="about">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">Lista aktualnych użytkowników</h2>
					<hr class="primary">
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<table class="table table-striped table-hover table-bordered">
				...
				<c:forEach items="${users}" var="user">
					<tr>
						...
						<td>${user.password}</td>
						<td><a
							href="<c:url value="/adminPanel/uzytkownicy/${user.id}/edytujUzytkownika" />"
							class="btn btn-success btn-xs">Edytuj</a> <a
							href="<c:url value="/adminPanel/uzytkownicy/${user.id}/usun" />"
							class="btn btn-success btn-xs">Usun</a></td>
			...
			<a href="<c:url value="/adminPanel/uzytkownicy/dodajUzytkownika" />"
				class="btn btn-success">Dodaj uzytkownika</a>
		</div>
